...
The fix requires changes to two functions in [`tips/ref-impls/src/StablecoinDEX.sol`](https://github.com/aquariusluo/tempo/blob/main/tips/ref-impls/src/StablecoinDEX.sol):

### 1. `_fillOrder` ([line 551-556](https://github.com/aquariusluo/tempo/blob/main/tips/ref-impls/src/StablecoinDEX.sol#L551-L556))
...
### 2. `_fillOrdersExactIn` ([line 923-926](https://github.com/aquariusluo/tempo/blob/main/tips/ref-impls/src/StablecoinDEX.sol#L923-L926))
